...
async def start():
    ...
    await cl.Message(
        content="Welcome! I'm using a local model running in vLLM with MCP integration. Make sure that: \n"
        "Your vLLM is running \n"
    ).send()
...
async def on_message(message: cl.Message):
    ...
    try:
        ...
        troubleshooting = (
            ...
            "3. Confirm that you connect to the port of the vLLM server\n"
...
if __name__ == "__main__":
    print("Starting Chainlit app with vLLM and MCP integration...")
